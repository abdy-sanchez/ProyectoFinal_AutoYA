...
function DispalyReservas(reservasOBJCT) {
    ...
    if(reservasOBJCT[2] == null){
        ...
        for( reserv of reservasJSONArray){
            ...
            deleteIcon.setAttribute("id", reserv.reservaID);

            deleteIcon.innerHTML = `<i class="fa-solid fa-trash" id="${reserv.reservaID}"></i>`;

            resumenReserv.innerHTML = `<i class="fa-solid fa-car"></i>  ${reserv.resumen}`;
